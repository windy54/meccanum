...
class HCSR04:
    ...
    # speed of sound is 300 m/sec or 30 cm/s 
    # max range of 500 cm, means wave has travlled 2 * 500 cm
    # so time = range / speed
    #         = 30 / (2 * 500) seconds = 30/1000 seconds which is 30,000 micro seconds
...
#frontSonar = HCSR04(trigger_pin=17, echo_pin=16, echo_timeout_us=10000)
    while True:
        print(frontSonar.distance_cm() )
        sleep_us(5000)
